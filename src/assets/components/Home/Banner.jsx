  ...
  return (
    <section 
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 rounded-2xl overflow-hidden shadow-lg">
        ...
        <div
          className=" animate-slide-left relative flex-1 min-h-[220px] md:min-h-80 transform transition duration-700 hover:scale-[1.02]"
        ...
        <div
          className="animate-slide-right relative flex-1 h-[400px] min-h-[220px] md:min-h-80 transform transition duration-700 hover:scale-[1.02]"
          style={
            rightBg
              ? bgStyle(rightBg)
              : {
