      ...
      <div className="flex flex-col mt-25 sm:flex-row gap-2 sm:gap-4 md:gap-6 rounded-2xl overflow-hidden shadow-lg">
        ...
        <div
          ...
          <div className="relative z-10 flex flex-col items-start justify-end h-full p-6 md:p-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold sm:font-bold text-white drop-shadow">
              Dive into great reads
            </h2>
            <p className="mt-2 text-sm sm:text-sm md:text-base text-white/90 max-w-sm">
            ...
            <div className="mt-4">
              <Link
                to="/all-books"
                className="inline-block px-5 py-2 rounded-md bg-secondary text-white hover:bg-red-600 text-sm sm:text-lg font-medium shadow-sm transition hover:translate-y-[-2px] hover:shadow-md">
                All Books
              </Link>
            </div>
          </div>
        ...
        <div
          className="animate-slide-right relative flex-1 min-h-[180px] sm:min-h-[220px] md:min-h-80 transform transition duration-700 hover:scale-[1.02]"
          style={
            rightBg
              ? bgStyle(rightBg)
              : {
          ...
          <div className="relative z-10 flex flex-col items-end justify-end h-full p-6 md:p-8 text-right">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold sm:font-bold text-white drop-shadow">
              Share your knowledge
            </h3>
            <p className="mt-2 text-sm sm:text-sm md:text-base text-white/85 max-w-sm">
